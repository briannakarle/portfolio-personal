...
$publickey = "6Lf-OAUTAAAAAEpETk3dI6uuUWmKHDlWyjrTf6s6";
$privatekey = "6Lf-OAUTAAAAAPGbfzKSOu_xHCmbCqakgL0hqnvI";

#EDIT THE FOLLOWING:
$toAddress = "briannarkarle@gmail.com";  //place your/your client's email address here - EDISON/ZEPHIR WILL ONLY EMAIL seattlecentral.edu ADDRESSES!
$toName = "Brianna Karle"; //place your client's name here
$website = "Brianna Karle- Portfolio";  //place NAME of your client's website here
...
?>
	...
	<div>	
		<label>
			Request:<br /><textarea name="Request" cols="36" rows="4" placeholder="Please let me know what I can help you with!" tabindex="30"></textarea>
		</label>
	</div>	
	<div>
		<?php 
